        ...
        <div className="flex flex-col md:flex-row justify-between gap-8 max-w-6xl mx-auto text-xs text-gray-700">
          <div className="md:w-1/4">
            ...
            <div className="flex gap-4">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:opacity-60 transition"><IconInstagram className="w-5 h-5" /></a>
              <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="hover:opacity-60 transition"><IconTiktok className="w-5 h-5" /></a>
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="hover:opacity-60 transition"><IconYoutube className="w-5 h-5" /></a>
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hover:opacity-60 transition"><IconFacebook className="w-5 h-5" /></a>
            </div>
          </div>
