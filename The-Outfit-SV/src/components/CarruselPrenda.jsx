...
function CarruselPrendas() {
  ...
  return (
    <div className="carrusel-wrap">
      <button onClick={anterior} disabled={indice === 0} className="buttons-move-card"><img src="/ICONOS/previous.png" alt="" /></button>
      ...
      <button onClick={siguiente} disabled={indice + 3 >= prendas.length} className="buttons-move-card"> <img src="/ICONOS/next.png" alt="" /></button>
    </div>
  );
}
